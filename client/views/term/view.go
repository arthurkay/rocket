...
func (v *TermView) draw() {
	...
	case mvc.UpdateInstalling:
		updateMsg = "rocket is updating"
	case mvc.UpdateReady:
		updateMsg = "rocket has updated: restart rocket for the new version"
	case mvc.UpdateAvailable:
		updateMsg = "new version available at https://github.com/arthurkay/rocket"
	default:
	...
	v.APrintf(termbox.ColorBlue|termbox.AttrBold, 0, 0, "rocket")
