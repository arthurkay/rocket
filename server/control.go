...
func NewControl(ctlConn conn.Conn, authMsg *msg.Auth) {
	...
	if authMsg.Version != version.Proto {
		failAuth(fmt.Errorf("incompatible versions. Server %s, client %s. Download a new version at https://github.com/arthurkay/rocket", version.MajorMinor(), authMsg.Version))
		return
	}
